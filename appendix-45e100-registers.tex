...
Example programs for the ethernet controller exist in imperfect states in the MEGA65 Core repository on github in the src/tests and src/examples directories.
